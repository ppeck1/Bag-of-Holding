...
from app.core.logical_libraries import InvalidLibraryId, resolve_logical_library
...
def get_cards(
    ...
    try:
        ...
        cards = list_cards(
            plane=plane, card_type=card_type, library_id=library_id, d=d, m=m,
    ...
    return {
        ...
        "filters": {
            "plane": plane, "card_type": card_type, "library_id": library_id,
