...
def api_register_route(req: EscalationRouteRequest, _operator: str = Depends(require_operator)):
...
def api_run_escalation(node_id: str, _operator: str = Depends(require_operator)):
...
def api_escalate_all(plane: Optional[str] = Query(None), limit: int = Query(200, ge=1),
