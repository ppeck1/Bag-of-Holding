...
def request_supersede(req: SupersedeRequest, _operator: str = Depends(require_operator)):
...
def request_patch(req: PatchRequest, _operator: str = Depends(require_operator)):
...
def request_edge(req: EdgeRequest, _operator: str = Depends(require_operator)):
...
def approve(approval_id: str, decision: ReviewDecision, _operator: str = Depends(require_operator)):
...
def reject(approval_id: str, decision: ReviewDecision, _operator: str = Depends(require_operator)):
...
def approve_edge(edge_apr_id: str, decision: ReviewDecision, _operator: str = Depends(require_operator)):
...
def list_pending(doc_id: Optional[str] = None, limit: int = Query(50, ge=1)):
...
def approval_ledger(status: Optional[str] = None, action_type: Optional[str] = None, doc_id: Optional[str] = None, limit: int = Query(200, ge=1)):
...
def list_pending_edges(limit: int = Query(50, ge=1)):
