...
def api_apply_feedback_rewrite(req: FeedbackRewriteRequest, _operator: str = Depends(require_operator)):
...
def api_revert_rewrite(rewrite_id: str, req: RevertRewriteRequest, _operator: str = Depends(require_operator)):
