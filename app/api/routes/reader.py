...
from app.core.logical_libraries import InvalidLibraryId
...
def get_graph(
    ...
    """
    try:
        return get_graph_data(max_nodes=max_nodes, library_id=library_id)
...
def get_graph_projection(
    ...
    try:
        return get_projection_graph(mode=mode, max_nodes=max_nodes, library_id=library_id)
    except InvalidLibraryId as exc:
        raise HTTPException(status_code=400, detail=str(exc))
