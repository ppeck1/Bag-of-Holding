...
def api_trigger_re_anchor(req: ReAnchorRequest, _operator: str = Depends(require_operator)):
...
def api_resume_on_single_plane(req: ResumePlaneRequest, _operator: str = Depends(require_operator)):
...
def api_create_open_item(req: OpenItemRequest, _operator: str = Depends(require_operator)):
...
def api_expire_stale(_operator: str = Depends(require_operator)):
...
def api_resolve_open_item(item_id: str, req: ResolveItemRequest, _operator: str = Depends(require_operator)):
