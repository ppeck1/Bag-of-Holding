...
def request_cert(req: CertificateRequest, _operator: str = Depends(require_operator)):
...
def review_cert(req: ReviewRequest, _operator: str = Depends(require_operator)):
...
def apply_certified_promotion(req: ApplyPromotionRequest, _operator: str = Depends(require_operator)):
...
def request_reversion(req: ReversionRequest, _operator: str = Depends(require_operator)):
