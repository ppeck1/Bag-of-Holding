...
def get_lifecycle_history(doc_id: str, limit: int = Query(50, ge=1)):
...
def move_backward(doc_id: str, req: BackwardRequest, _operator: str = Depends(require_operator)):
    ...
    """
    # WO-2 mutation isolation (gate-independent).
...
def undo_lifecycle(doc_id: str, req: UndoRequest, _operator: str = Depends(require_operator)):
