...
@router.post("/register", summary="Register a domain object in the substrate lattice (operator only)")
def api_register(req: LatticeObjectRequest, _operator: str = Depends(require_operator)):
