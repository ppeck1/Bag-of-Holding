...
def ollama_invoke(req: InvokeRequest, _operator: str = Depends(require_operator)):
...
def set_ollama_enabled(req: OllamaToggleRequest, _operator: str = Depends(require_operator)):
