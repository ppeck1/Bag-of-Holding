...
function ExportTab() {
  ...
  let corpusBtn, auditBtn;
  return h("div", { class: "col gap-3", style: { marginTop: "16px" } },
    Card({ title: "Document corpus", children: h("div", { class: "col gap-3" },
    ...
    Card({ title: "Audit log", children: h("div", { class: "col gap-3" },
      ...
      h("div", { class: "exp-err t-small", style: { color: "var(--state-conflict)" } })) }),
    Card({ title: "ICS — Interoperable Context Snapshot", children: h("div", { class: "col gap-3" },
      h("div", { class: "t-small", style: { color: "var(--text-secondary)" } }, "Full provenance-aware ICS export (lineage, authority certificates, governance metadata) is a planned future format. Use the corpus JSON export above in the meantime."),
      h("div", { class: "kv" },
        kvRow("Status", "Planned — not yet implemented"),
        kvRow("Governance note", "ICS will be operator-gated and include lineage, authority, and canon provenance."))) }));
}
