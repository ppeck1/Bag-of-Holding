...
-- Phase 28.5: Planar Gate + Correction Ledger. Additive correction memory.
...
-- Retrieval v1: stable source chunks for LLM context packs.
...
-- Compatibility surface for the Planar Storage bridge. The existing cards table
-- remains the source of truth; this view gives the bridge the expected name.
