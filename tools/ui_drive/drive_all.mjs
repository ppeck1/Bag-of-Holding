...
try {
  ...
  const tbEl = sh.TopBar({ mode: 'advanced', onMode: () => {},
    libraries: [{ id: 'all', name: 'All libraries', count: 0 }], activeLibraryId: 'all', onSelectLibrary: () => {},
  ...
  rec('Shell/TopBar-library-chip', tbText.includes('Library: All libraries'),      'present=' + tbText.includes('Library: All libraries'));
